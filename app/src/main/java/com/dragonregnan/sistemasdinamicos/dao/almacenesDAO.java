...
public class almacenesDAO {
    ...
    public void insertAlmacen (almacenesModel almacen) {
        ...
        if(!existsAlmacen(almacen.getIdEmpresa(),almacen.getIdTipoAlmacen())){
            ...
            Toast toast = Toast.makeText(context, "Almacen actualizado", Toast.LENGTH_LONG);
            toast.show();
        }
    }

    public boolean existsAlmacen( int idempresa, int idTipoAlmacen ){
        boolean exist = false;
